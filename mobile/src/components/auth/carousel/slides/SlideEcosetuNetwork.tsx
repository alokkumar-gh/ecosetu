...
import { NetworkGraph } from '../graphics/NetworkGraph';
...
export const SlideEcosetuNetwork: React.FC<SlideProps> = ({ width, active }) => {
  ...
  return (
    <View style={[styles.slideContainer, { width }]}>
      ...
      <View style={styles.tagContainer}>
        ...
        <Text style={styles.tagText}>THE ECOSYSTEM</Text>
      </View>
