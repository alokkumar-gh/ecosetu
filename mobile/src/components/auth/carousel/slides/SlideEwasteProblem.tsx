...
import { DeviceSilhouettes } from '../graphics/DeviceSilhouettes';
...
export const SlideEwasteProblem: React.FC<SlideProps> = ({ width, active }) => {
  ...
  return (
    <View style={[styles.slideContainer, { width }]}>
      ...
      <View style={styles.tagContainer}>
        ...
        <Text style={styles.tagText}>THE CHALLENGE</Text>
      </View>
      ...
      >
        <DeviceSilhouettes active={active} />
      </Animated.View>
