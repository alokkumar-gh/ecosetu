...
import { ImpactVisualization } from '../graphics/ImpactVisualization';
...
export const SlideImpact: React.FC<SlideProps> = ({ width, active }) => {
  ...
  return (
    <View style={[styles.slideContainer, { width }]}>
      ...
      <View style={styles.tagContainer}>
        ...
        <Text style={styles.tagText}>ENVIRONMENTAL IMPACT</Text>
      </View>
      ...
      >
        <ImpactVisualization active={active} />
      </Animated.View>
...
const styles = StyleSheet.create({
  ...
  tagDot: {
    ...
    height: 6,
    borderRadius: 3,
    backgroundColor: colors.carousel.nodeActive,
  },
  tagText: {
    fontSize: 10,
    fontWeight: '800',
    color: colors.carousel.nodeActive,
    letterSpacing: 1.2,
  },
  graphicWrapper: {
    alignItems: 'center',
