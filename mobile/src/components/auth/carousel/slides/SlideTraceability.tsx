...
import { TraceabilityTimeline } from '../graphics/TraceabilityTimeline';
...
export const SlideTraceability: React.FC<SlideProps> = ({ width, active }) => {
  ...
  return (
    <View style={[styles.slideContainer, { width }]}>
      ...
      <View style={styles.tagContainer}>
        ...
        <Text style={styles.tagText}>VERIFIED AUDIT</Text>
      </View>
      ...
      >
        <TraceabilityTimeline active={active} />
      </Animated.View>
...
const styles = StyleSheet.create({
  ...
  tagText: {
    fontSize: 10,
    fontWeight: '800',
    color: colors.carousel.accentTeal,
    letterSpacing: 1.2,
  },
  graphicWrapper: {
    alignItems: 'center',
