          ...
          <ScrollView style={styles.stepContent} showsVerticalScrollIndicator={false}>
            {successInfo && (
              <View style={styles.successBanner}>
                <AppIcon name="checkCircle" size={16} color="#34D399" style={{ marginRight: 6 }} />
              ...
              <View style={styles.itemsSummaryBadge}>
                <View style={styles.itemsSummaryLeft}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 2 }}>
                    <AppIcon name="box" size={15} color="#34D399" style={{ marginRight: 6 }} />
                          ...
                          {isDifferent && (
                            ...
                            >
                              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <AppIcon name="check" size={14} color="#FFF" style={{ marginRight: 5 }} />
                  ...
                  (() => {
                    ...
                    return (
                      <View>
                        <View style={styles.aiCardHeaderRow}>
                          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <AppIcon name="search" size={16} color="#94A3B8" style={{ marginRight: 6 }} />
                    ...
                    return (
                      <View>
                        ...
                        <View style={styles.aiActionRow}>
                          ...
                          >
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                              <AppIcon name="recycle" size={14} color="#FFF" style={{ marginRight: 5 }} />
              ...
              <View style={styles.addrTypeRow}>
                {[ADDRESS_TYPES.HOME, ADDRESS_TYPES.OFFICE, ADDRESS_TYPES.OTHER].map((type) => {
                  ...
                  return (
                    <TouchableOpacity
                      key={type}
                      style={[styles.addrTypePill, isActive && styles.addrTypePillActive]}
